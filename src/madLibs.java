...
public class madLibs {
	...
	public static void main(String[] args) {
		...
		System.out.println("Afterwards, the "+noun3+" came out of nowhere and wanted to "+verb3+" the "+adjective3+" bird.");
		System.out.println("Finally, the story ends after people try to slot "+noun4+" into vending machines to "+verb4+" and the "+adjective4+" monster.");
		scan.close();
	}
